...
export const loadMetrics = function loadMetrics(url) {
    return new Promise((resolve, reject) => {
...
export const loadAccessibility = function loadAccessibility(url) {
    return new Promise((resolve, reject) => {
        fetch("/api/check-accessibility", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
...
export const loadSQL = function loadSQL(url) {
    return new Promise((resolve, reject) => {
        fetch("/api/check-sql", {
            method: "POST",
            headers: {
...
export const loadXSS = function loadXSS(url) {
    return new Promise((resolve, reject) => {
        fetch("/api/check-xss", {
            method: "POST",
            headers: {
